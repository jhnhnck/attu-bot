...
from doom_bot.database.models import MessageAuthor, MessageContent, MessageDocument, MessageRefs
...
def mock_message_repo():
    """Patch doom_bot.messages._get_repo and doom_bot.commands.fix.messages._get_repo to return an AsyncMock repo."""
    repo = AsyncMock()
    with patch('doom_bot.client.messages._get_repo', return_value=repo), patch('doom_bot.commands.fix.messages._get_repo', return_value=repo):
        yield repo
...
class TestStoreMessage:
    async def test_calls_upsert(self, mock_message_repo, guild):
        ...
        with patch('doom_bot.client.messages._is_archive_channel', return_value=False):
...
class TestLogEdit:
    async def test_sends_embed_to_logs(self, mock_message_repo, guild):
        ...
        with patch('doom_bot.client.messages._get_logs_channel', return_value=logs_ch):
    ...
    async def test_skips_dm(self, mock_message_repo):
        ...
        with patch('doom_bot.client.messages._get_logs_channel', return_value=_make_logs_channel()) as mock_logs:
            await log_edit(payload)
    ...
    async def test_skips_if_no_logs_channel(self, mock_message_repo, guild):
        ...
        with patch('doom_bot.client.messages._get_logs_channel', return_value=None):
            await log_edit(payload)
    ...
    async def test_edit_embed_has_author_icon_url(self, mock_message_repo, guild):
        ...
        with patch('doom_bot.client.messages._get_logs_channel', return_value=logs_ch), patch('doom_bot.client.messages._resolve_avatar', return_value='https://example.com/avatar.png'):
            await log_edit(payload)
    ...
    async def test_edit_embed_no_icon_url_when_avatar_unavailable(self, mock_message_repo, guild):
        ...
        with patch('doom_bot.client.messages._get_logs_channel', return_value=logs_ch), patch('doom_bot.client.messages._resolve_avatar', return_value=None):
            await log_edit(payload)
...
class TestLogDelete:
    ...
    async def test_marks_deleted_in_db(self, mock_message_repo, guild):
        ...
        with patch('doom_bot.client.messages._get_logs_channel', return_value=_make_logs_channel()):
            await log_delete(_make_raw_delete_payload())
    ...
    async def test_skips_dm(self, mock_message_repo):
        ...
        with patch('doom_bot.client.messages._get_logs_channel') as mock_logs:
            await log_delete(payload)
            mock_logs.assert_not_called()
    ...
    async def test_skips_known_starboard_post(self, mock_message_repo, guild):
        ...
        logs_ch = _make_logs_channel()
        with patch('doom_bot.client.messages._get_logs_channel', return_value=logs_ch), patch('doom_bot.client.starboard._get_repo', return_value=mock_sb_repo):
            await log_delete(_make_raw_delete_payload())
    ...
    async def test_shows_deleted_by_when_mod_found_in_audit_log(self, mock_message_repo, guild):
        ...
        logs_ch = _make_logs_channel()
        with patch('doom_bot.client.messages._get_logs_channel', return_value=logs_ch), patch('doom_bot.client.messages.bot') as mock_bot:
...
class TestOnMessage:
    async def test_stores_message_for_valid_guild(self, mock_message_repo, guild):
        from doom_bot.client.events import on_message

        msg = _make_mock_message()
        with patch('doom_bot.client.messages.store_message', new=AsyncMock()) as mock_store, patch('doom_bot.client.messages._is_archive_channel', return_value=False):
    ...
    async def test_skips_dm(self, mock_message_repo, guild):
        ...
        with patch('doom_bot.client.messages.store_message', new=AsyncMock()) as mock_store:
            await on_message(msg)
...
class TestOnRawMessageEdit:
    async def test_calls_log_edit_for_valid_guild(self, mock_message_repo, guild):
        from doom_bot.client.events import on_raw_message_edit

        payload = _make_raw_edit_payload()

        with patch('doom_bot.client.messages.log_edit', new=AsyncMock()) as mock_log:
...
class TestOnRawMessageDelete:
    async def test_calls_log_delete_for_valid_guild(self, mock_message_repo, guild):
        from doom_bot.client.events import on_raw_message_delete

        payload = _make_raw_delete_payload()

        with patch('doom_bot.client.messages.log_delete', new=AsyncMock()) as mock_log:
...
class TestOnRawBulkMessageDelete:
    async def test_calls_log_bulk_delete_for_valid_guild(self, mock_message_repo, guild):
        from doom_bot.client.events import on_raw_bulk_message_delete

        payload = _make_raw_bulk_delete_payload()

        with patch('doom_bot.client.messages.log_bulk_delete', new=AsyncMock()) as mock_log:
...
class TestJobFixAuthorNames:
    async def test_updates_all_users(self, mock_message_repo, guild):
        from doom_bot.commands.fix import job_fix_author_names
        ...
        with patch('doom_bot.bot') as mock_bot:
...
class TestSerializeEmbeds:
    ...
    def test_empty_embed(self):
        from doom_bot.client.messages import _serialize_embeds
...
class TestIsPublic:
    def test_no_guild_returns_false(self):
        from doom_bot.client.messages import _is_public
...
class TestIsArchiveChannel:
    def test_returns_false_when_guild_not_found(self):
        from doom_bot.client.messages import _is_archive_channel

        with patch('doom_bot.client.messages.config') as mock_config:
...
class TestBackupPath:
    def test_returns_none_when_backup_disabled(self):
        from doom_bot.client.messages import _backup_path
...
class TestTruncate:
    def test_short_string_unchanged(self):
        from doom_bot.client.messages import _truncate
...
class TestGetLogsChannel:
    async def test_returns_none_when_guild_not_found(self):
        from doom_bot.client.messages import _get_logs_channel
    ...
    async def test_returns_none_when_bot_guild_not_found(self):
        ...
        with patch('doom_bot.client.messages.config') as mock_config, patch('doom_bot.client.messages.bot') as mock_bot:
            mock_config.guild.return_value = gc
...
class TestResolveAvatar:
    def test_returns_member_avatar_when_found(self):
        from doom_bot.client.messages import _resolve_avatar
        ...
        with patch('doom_bot.client.messages.bot') as mock_bot:
            mock_bot.get_guild.return_value = mock_guild
