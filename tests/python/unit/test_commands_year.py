...
class TestYearCheckCommand:
    ...
    async def test_check_prior_year(self, mock_ctx, guild):
        ...
        from nova_core.commands.year import year_check
        ...
        with patch('nova_core.commands.year.get_year_span', new_callable=AsyncMock, return_value=mock_span_obj), patch('nova_core.commands.year.get_year_status', return_value=(7, 2)), patch('nova_core.client.years.Year.get', new_callable=AsyncMock, return_value=None):
    ...
    async def test_check_current_year(self, mock_ctx, guild):
        ...
        with patch('nova_core.commands.year.get_year_span', new_callable=AsyncMock, return_value=mock_span_obj), patch('nova_core.commands.year.get_year_status', return_value=(7, 2)):
    ...
    async def test_check_next_year_approaching(self, mock_ctx, guild):
        ...
        with patch('nova_core.commands.year.get_year_span', new_callable=AsyncMock, return_value=mock_span_obj), patch('nova_core.commands.year.get_year_status', return_value=(13, 1)):
            await year_check(mock_ctx, year=2)
    ...
    async def test_check_next_year_normal(self, mock_ctx, guild):
        ...
        with patch('nova_core.commands.year.get_year_span', new_callable=AsyncMock, return_value=mock_span_obj), patch('nova_core.commands.year.get_year_status', return_value=(7, 1)):
            await year_check(mock_ctx, year=2)
...
class TestYearSearchCommand:
    ...
    async def test_search_normal_year(self, mock_ctx, make_guild):
        ...
        from nova_core.client.calendar import AttuYearSpan
        from nova_core.commands.year import year_search
    ...
    async def test_search_far_future_year(self, mock_ctx, guild):
        ...
        with patch('nova_core.commands.year.get_year_status', return_value=(7, 1)):
...
class TestYearLinkCommand:
    ...
    async def test_link_valid_year_and_channel(self, mock_ctx, make_guild):
        ...
        from nova_core.commands.year import year_link
        ...
        with patch('nova_core.commands.year.find_marker_link') as mock_find:
            mock_find.return_value = 'https://discord.com/channels/123/456/789'

            with patch('nova_core.commands.year.get_year_status', return_value=(7, 2)):
