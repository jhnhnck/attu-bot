...
class TestGetViewerUrl:
    ...
    async def test_successful_response_returns_url(self):
        ...
        with patch('attubot.client.families.httpx.AsyncClient', return_value=mock_client):
    ...
    async def test_api_error_in_body_raises_valueerror(self):
        ...
        with patch('attubot.client.families.httpx.AsyncClient', return_value=mock_client), pytest.raises(ValueError, match='FamilyEcho API error'):
    ...
    async def test_missing_url_in_response_raises_valueerror(self):
        ...
        with patch('attubot.client.families.httpx.AsyncClient', return_value=mock_client), pytest.raises(ValueError, match='unexpected FamilyEcho API response'):
    ...
    async def test_http_error_propagates(self):
        ...
        with patch('attubot.client.families.httpx.AsyncClient', return_value=mock_client), pytest.raises(httpx.HTTPStatusError):
            await get_viewer_url('content')
...
class TestGetRepoGuard:
    ...
    async def test_get_family_raises_when_repo_none(self):
        with patch('attubot.client.families._family_repo', None), pytest.raises(RuntimeError, match='family repo not initialized'):
...
class TestGetFamily:
    ...
    async def test_family_found(self):
        ...
        with patch('attubot.client.families._family_repo', mock_repo):
