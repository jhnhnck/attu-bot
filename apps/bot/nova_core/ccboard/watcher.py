...
"""nova_core.ccboard.watcher | reaction event handlers for the ccboard system."""
...
def _get_message_repo():
    # imported here so ccboard.watcher can be imported before nova_core.client.messages
    # finishes wiring its module-level singleton during startup
    from nova_core.client.messages import _get_repo as _msg_repo
