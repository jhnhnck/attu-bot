...
"""doom_bot.database | database package.

Documents, repositories, and MongoStorage live in the `attu_models` workspace
package; this module re-exports them so the existing `from doom_bot.database
...
def _wire_repos(*, family_repo, marker_repo, year_repo, signal_repo, message_repo, starboard_repo, egg_repo, egg_user_repo, wiki_view_repo, reminder_repo) -> None:
    ...
    import doom_bot.commands.wiki as _wiki
    import doom_bot.eggs.hatching as _hatching
    import doom_bot.signals as _signals
    import doom_bot.tasks.reminder as _reminder
...
async def init_database(url: str, name: str):
    ...
    Args:
        ...
        name: Database name
    """
    from doom_bot import config, db
