...
"""doom_bot.tasks.message_backfill | message backfill task."""
...
from doom_bot.client.messages import _get_repo, build_message_doc
...
class MessageBackfillTask(BaseTask):
    ...
    async def _reconcile_pending_starred_docs(self, guild_id: int) -> None:
        ...
        from doom_bot.client.core import config as _config
        from doom_bot.client.starboard import _get_repo as _get_sb_repo
        from doom_bot.client.starboard import _sync_starboard_post, backfill_message_reactions
