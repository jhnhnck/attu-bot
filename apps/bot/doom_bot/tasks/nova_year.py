...
"""doom_bot.tasks.nova_year | guild year rollover task."""

import re
from datetime import datetime

from doom_bot import bot, config
from doom_bot.client.calendar import format_year_line, get_next_year, get_year_status
...
from doom_bot.config import GuildConfig
...
async def job_construct_year_links(guild_id: int):
    ...
    from doom_bot import bot, config
    from doom_bot.client.calendar import format_year_line, get_year_span
    from doom_bot.client.years import Year
    from doom_bot.commands.year import find_marker_link
