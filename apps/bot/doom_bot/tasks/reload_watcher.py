...
"""doom_bot.tasks.reload_watcher | reload watcher task."""
        ...
        for signal in signals:
            try:
                if signal.signal_type == 'guild':
                    ...
                    from doom_bot.tasks.logo_update import logo_update_task  # local import avoids circular dependency with tasks/__init__.py
                    from doom_bot.tasks.scheduler import scheduler  # local import avoids circular dependency with tasks/__init__.py
