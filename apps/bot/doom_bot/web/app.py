...
"""doom_bot.web.app | main quart application."""
...
from doom_bot.web.audit import AuditLogger
...
def _register_startup(app: Quart, assets_dir: Path) -> None:
    ...
    async def shutdown() -> None:
        ...
        from doom_bot import bot as discord_bot
...
async def _initialize_startup(assets_dir: Path):
    from doom_bot.client.logo import generate_png
    from doom_bot.web.audit import AuditLogger
...
def _register_template_hooks(app: Quart) -> None:
    from doom_bot import __version__
    ...
    def format_uptime_filter(seconds):
        from doom_bot.web.helpers import format_uptime
...
def _register_rate_limits_and_routes(app: Quart) -> None:
    ...
    from doom_bot.web.routes import register_routes
...
def start_web():
    ...
    logger.info('starting doom_bot web interface')
    config.on_init()
