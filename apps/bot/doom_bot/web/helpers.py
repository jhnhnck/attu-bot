...
"""doom_bot.web.helpers | web helpers."""
...
async def get_admin_stats_data() -> dict:
    ...
    try:
        from doom_bot.eggs.hatching import _egg_repo as egg_repo
...
async def get_time_status_data(guild_id: int) -> dict:
    ...
    from doom_bot.client.calendar import get_next_year, get_year_status
...
async def get_recent_audit_data(guild_id: int | None = None, limit: int = 5) -> list[dict]:
    ...
    from doom_bot.web import app as web_app
...
async def get_guild_config_data(guild_id: int) -> dict:
    ...
    """
    from doom_bot.web.discord_integration import get_guild_channels, get_guild_roles, get_users_info
