...
def register_routes(app: Quart):  # noqa: PLR0915 - route registration defines many routes inline by design
    ...
    async def index():
        ...
        from doom_bot.web.helpers import get_admin_stats_data, get_recent_audit_data, get_time_status_data
    ...
    async def api_get_time_status(guild_id: int):
        ...
        try:
            from doom_bot.web.helpers import get_time_status_data
    ...
    async def api_get_year_span(guild_id: int, year: int):
        ...
        try:
            from doom_bot.client.calendar import get_year_span
    ...
    async def api_get_admin_stats():
        ...
        try:
            from doom_bot.web.helpers import get_admin_stats_data
