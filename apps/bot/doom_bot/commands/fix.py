...
"""doom_bot.commands.fix | fix commands."""
...
from doom_bot.client import messages
from doom_bot.client.starboard import _get_repo as _get_sb_repo
from doom_bot.client.starboard import _sync_starboard_post
from doom_bot.client.util import is_bot_owner
from doom_bot.logging import get_logger
from doom_bot.tasks import LogoUpdateTask, scheduler
from doom_bot.tasks.message_backfill import MessageBackfillTask
from doom_bot.tasks.nova_year import job_construct_year_links
...
async def job_fix_author_names(guild_id: int, status_msg: discord.Message | None = None, user_id: int | None = None):
    ...
    from doom_bot import bot
    from doom_bot.client.messages import _global_username
...
async def job_recover_starboard_from_channel(guild_id: int, days: int = 7, status_msg: discord.Message | None = None):  # noqa: PLR0912, PLR0915 - recovery scan with many error/skip branches
    ...
    from doom_bot import bot, config
    from doom_bot.client.starboard import _get_repo as _get_sb_repo_inner
    from doom_bot.client.starboard import _sync_starboard_post as _sync_post
...
async def fix_emoji(ctx: ApplicationContext):
    ...
    from doom_bot.eggs.emojis import ensure_egg_emojis, ensure_progress_emojis
