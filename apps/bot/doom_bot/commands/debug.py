...
"""doom_bot.commands.debug | debug commands."""
...
from doom_bot import __build_time__, __schema__, __title__, __version__, config
from doom_bot.client.calendar import get_year_span, get_year_status
...
from doom_bot.tasks import scheduler
...
async def debug_eggs_preview(ctx: ApplicationContext, rarity: str):
    ...
    from doom_bot.eggs.hatching import run_hatch_animation
