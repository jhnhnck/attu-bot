...
"""doom_bot.commands.eggs | egg game slash commands (loaded dynamically on hatch day)."""
...
from doom_bot.client.embeds import make_embed, ui_emoji
from doom_bot.database.models import EggDocument
from doom_bot.eggs import hatching
...
def _offer_text(from_mention: str, to_mention: str, egg: EggDocument, egg_jump_url: str) -> str:
    ...
    if egg.hatched:
        ...
        from doom_bot.eggs.hatching import _egg_emoji_str
...
class _EggSelectMenu(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        from doom_bot.eggs.hatching import _egg_repo, _egg_user_repo
...
async def eggs_view(ctx: ApplicationContext):
    ...
    from doom_bot.eggs.hatching import _egg_user_repo
