...
"""doom_bot.client.migrations | configuration migrations."""
...
async def migration_backfill_years():
    ...
    from doom_bot.client.calendar import get_year_status, seconds_per_day
    from doom_bot.client.core import db
...
async def migration_add_guild_to_markers():
    ...
    """
    from doom_bot.client.core import db
    from doom_bot.database.repositories import YearMarkerRepository
...
async def migration_fix_thread_parent_ids():
    ...
    from doom_bot.client.core import bot, db
