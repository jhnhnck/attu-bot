...
"""doom_bot.client.markers | year marker resolution and override storage."""
...
from doom_bot.database.repositories import MessageRepository, YearMarkerRepository
...
async def resolve_marker(guild: int, channel: int, year: int) -> ResolvedMarker:
    ...
    """
    from doom_bot.client.calendar import format_year_line
