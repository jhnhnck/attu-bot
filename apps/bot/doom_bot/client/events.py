...
"""doom_bot.client.events | bot event handlers."""
...
async def _restore_wiki_views():
    ...
    try:
        from doom_bot.commands.wiki import WikiLookupView, _get_view_repo, build_wiki_embed
        from doom_bot.wiki import get_wiki
        from doom_bot.wiki.models import PageSummary, SearchResult
...
async def _do_ready_init():
    ...
    try:
        from doom_bot.tasks import register_bot_tasks, scheduler
