...
| `scripts/coverage_report.py` | renders a `coverage.json` payload as the markdown coverage section in `notes/to-do.md`. pure formatter; reads stdin or path. `--threshold` for ci gating. |
