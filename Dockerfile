...
FROM ghcr.io/astral-sh/uv:python3.13-trixie AS git-info
...
FROM ghcr.io/astral-sh/uv:python3.13-trixie AS doombox
ENV TZ="America/New_York"
ENV FORCE_COLOR=1
